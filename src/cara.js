...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp halo bro
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id you gay
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig fian_014_
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & fian
➸ *${prefix}play*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta dahlah
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub Sadboy & bro
